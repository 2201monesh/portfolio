...
import ComboBoxAnimation from './_components/ComboBoxAnimation'

export default function ComboBoxAnimationPage() {
  return (
    <div className="mx-auto w-full max-w-3xl space-y-8 px-6 py-12 sm:px-10 sm:py-16 md:px-20 md:py-24 font-serif text-neutral-900">
      ...
      <header className="space-y-px">
        <div className="flex items-center justify-between">
          <h1 className="leading-snug font-medium tracking-tight">Combo box animation using motion</h1>
          <a
        ...
        <p className="text-sm leading-snug text-neutral-400">Jan 19, 2026</p>
      </header>
