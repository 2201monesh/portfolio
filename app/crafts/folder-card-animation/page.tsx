...
import FolderCardAnimation from './_components/FolderCardAnimation'

export default function FolderCardAnimationPage() {
  return (
    <div className="mx-auto w-full max-w-3xl space-y-8 px-6 py-12 sm:px-10 sm:py-16 md:px-20 md:py-24 font-serif text-neutral-900">
      ...
      <header className="space-y-px">
        <div className="flex items-center justify-between">
          <h1 className="leading-snug font-medium tracking-tight">Folder card animation</h1>
          <a
            href="https://x.com/moneshgoyal/status/2043915778916004018?s=20"
            target="_blank"
        ...
        <p className="text-sm leading-snug text-neutral-400">Apr 14, 2026</p>
      </header>
