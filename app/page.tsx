...
export default function Home() {
  ...
  <div className="space-y-4">
    <p className="leading-7">I'm a frontend engineer who enjoys building clean, modern UIs with smooth, minimal animations. I mostly work with React, Next.js, Tailwind CSS, and shadcn/ui, and I love turning well-thought-out designs into fast, polished web experiences.</p>
    <p className="leading-7">These days, I spend a lot of time using Framer Motion to add subtle motion-micro-interactions, transitions, and animations that make interfaces feel natural without being flashy. I care a lot about visual consistency, performance, and writing code that's easy to scale and maintain.</p>
    <p className="leading-7">Outside work, I experiment with side projects, explore new tools, and constantly level up my craft.</p>
    <p className="leading-7">For collaborations, reach me at <span className="link-text">moneshgoyal.work@gmail.com</span>. I also share about my work on <a href="https://x.com/moneshgoyal" target="_blank" rel="noopener noreferrer" className="link-text">X (Twitter)</a>. You can also see my project work on <a href="https://github.com/2201monesh" target="_blank" rel="noopener noreferrer" className="link-text">GitHub</a> and see my work experiences on <a href="https://www.linkedin.com/in/monesh-goyal/" target="_blank" rel="noopener noreferrer" className="link-text">LinkedIn</a>.</p>
  </div>
